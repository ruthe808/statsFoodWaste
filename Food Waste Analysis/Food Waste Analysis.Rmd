...
subtitle: "EDS 222: statistics for Environmental Data Science"  
...
```{r, echo=FALSE, out.width="100%", fig.cap= "Image: foodwa"}
knitr::include_graphics(here::here(file.path("img", "foodwaste.png")))
```
